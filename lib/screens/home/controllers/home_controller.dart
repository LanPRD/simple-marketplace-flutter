...
class HomeController extends GetxController {
  ...
  List<Product> get allProducts => currentCategory?.items ?? [];
  ...
  void filterByTitle() {
    ...
    if (searchTitle.value.isEmpty) {
      ...
      Category? c = allCategories.firstWhereOrNull((cat) => cat.id == '');
  ...
  Future<void> getAllProducts({bool canLoad = true}) async {
    ...
    HomeResult<Product> result = await homeRepository.getAllProducts(body);
